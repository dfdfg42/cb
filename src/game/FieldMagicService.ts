import { GameSession, FieldMagic } from '../types';
...
export class FieldMagicService {
  ...
  public static createFieldMagic(id: string, name: string, casterId: string, duration: number, effect?: string): FieldMagic {
    return {
      id,
      name,
      casterId,
...
export default FieldMagicService;
